...
public class TestCss3List extends DemoTest 
{
	private String consoleText;
	private final String url = DButilities.DB_SERVER+ "/TestSuite/Test_css3List/index.html?stb=TNC01";
	...
	public void beforeClass() throws Exception 
	{
		...
		System.out.println("css3list.setUp()");
		wd.get(url);
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("CSS3 Horizontal list",
				       "Check performances of an horizontal list using CSS3 transitions",
				       "internal", 
				        url);
