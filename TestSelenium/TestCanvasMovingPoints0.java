...
public class TestCanvasMovingPoints0 extends TestCanvas 
{
	private String consoleText;
	private final String url = DButilities.DB_SERVER+ "/TestSuite/CanvasTest/moving_points.html?type=0&stb=TNC01";
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("Square canvas performances",
				       "Check performances when displaying some squares into a canvas",
				       "internal", url);
