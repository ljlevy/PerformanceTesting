...
public class TestCanvasMovingPoints6 extends TestCanvas 
{
	private String consoleText;
	private final String url = DButilities.DB_SERVER+ "/TestSuite/CanvasTest/moving_points.html?type=6&stb=TNC01";
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("SquareOutline canvas performances",
				       "Check performances when displaying square outlines into a canvas",
				       "internal", 
				       url);
