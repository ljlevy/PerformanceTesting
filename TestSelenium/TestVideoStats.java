...
public class TestVideoStats extends DemoTest 
{
	private final String url = DButilities.DB_SERVER+ "/TestSuite/TestVideo/video_stats.html";
	...
	public void beforeClass() throws Exception 
	{
		...
		System.out.println("TestVideoStats.setUp()");
		wd.get(url);

		System.out.println("TestVideoStats.setUp() current url "+ wd.getCurrentUrl());
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("Frame score statistics on mp4",
				       "Statistics and score on decoding frames on mp4", 
				       "internal",
				        url);
