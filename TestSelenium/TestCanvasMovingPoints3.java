...
public class TestCanvasMovingPoints3 extends TestCanvas 
{
	private String consoleText;
	private final String url = DButilities.DB_SERVER+ "/TestSuite/CanvasTest/moving_points.html?type=3&stb=TNC01";
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("LinedSquare canvas performances",
				       "Check performances when displaying some lined squares into a canvas",
				       "internal", 
				       url);
