...
public class TestCanvasMovingPoints1 extends TestCanvas 
{
	private String consoleText;
	private final String url = DButilities.DB_SERVER+ "/TestSuite/CanvasTest/moving_points.html?type=1&stb=TNC01";
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("Triangle canvas performances",
				       "Check performances when displaying some triangles into a canvas",
				       "internal", 
				       url);
