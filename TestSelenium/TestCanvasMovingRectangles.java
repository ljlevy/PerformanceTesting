...
public class TestCanvasMovingRectangles extends TestCanvas 
{
	private String consoleText;
	private final String url = DButilities.DB_SERVER+ "/TestSuite/CanvasTest/moving_rectangles.html?stb=TNC01";
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("SnowflakeRectangles canvas performances",
				       "Check performances when displaying snowflakes rectangles into a canvas",
				       "internal", 
				       url);
