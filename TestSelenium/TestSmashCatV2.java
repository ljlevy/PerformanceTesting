...
public class TestSmashCatV2 extends DemoTest {

	private final String url = DButilities.DB_SERVER+ "/TestSuite/CanvasTest/smashcatv2/smashcat_canvas_test.htm";
	...
	public void beforeClass() throws Exception 
	{
		...
		System.out.println("SmashCatV2.setUp()");
		wd.get(url);
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("Canvas SmashCatV2", 
