...
public class TestCanvasMovingPoints5 extends TestCanvas 
{
	private String consoleText;
	private final String url = DButilities.DB_SERVER+ "/TestSuite/CanvasTest/moving_points.html?type=5&stb=TNC01";
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("Cloud canvas performances",
				       "Check performances when displaying clouds into a canvas",
				       "internal", 
				        url);
