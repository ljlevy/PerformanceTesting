...
public class TestCanvasMovingPoints4 extends TestCanvas 
{
	private String consoleText;
	private final String url = DButilities.DB_SERVER+ "/TestSuite/CanvasTest/moving_points.html?type=4&stb=TNC01";
	...
	public void testFPS() 
	{
		...
		DB.addTestCase("Snowflake canvas performances",
				       "Check performances when displaying snowflakes into a canvas",
				       "internal",
				       url);
