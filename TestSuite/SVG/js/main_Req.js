...
function init()
{
	...
	if (location.match(/shadows=true/))
	{
		...
		console.log("Classname is shadows ");
	}
	...
	if (location.match(/particles=/))
	{
		...
		console.log("Classname is particules ");
	...
	console.log(" MAX_PARTICLES is "+MAX_PARTICLES+" "); 
...
function animate_ljl() {

	requestAnimationFrame( animate_ljl );
...
function render() {
   ...
   // Nothing except getting stats after request animation
