...
function preprocessChars(charsTab, scene) {
	var n,p,i,i2,aP=[];
	...
	for(p in charDef){
		charsTab[n]=new Object3D();
		charsTab[n].setPoints(charDef[p]['points']);
		charsTab[n].setPolys(charDef[p]['polys']);
		charsTab[n].translate(0,0,100);
		charsTab[n].setZoom(20);
		scene.addObject(charsTab[n]);
		++n;
	}
